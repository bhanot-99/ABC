    ...
    <header className=" text-black p-4  bg-[#040B11]">
      <div className="container mx-auto px-10 flex justify-between items-center  bg-[#040B11]">
        ...
        <nav className="flex items-center gap-6 font-bold  bg-[#040B11]">
          ...
          {!walletAddress && <button className="   text-black py-2 px-4 mr-7 rounded flex items-center gap-[2px] bg-[#21e786]  transition-all duration-100 hover: hover:text-xl" onClick={connectWallet} ref={connectWalletRef}>Connect Wallet <img src={metamask} className='w-15'/></button>}
          {
            walletAddress && <button className='whitespace-nowrap text-white text-xs hover:text-[#21e786]' onClick={()=>{
              navigate('/myBalance');
